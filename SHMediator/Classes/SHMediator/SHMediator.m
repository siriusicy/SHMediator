...
NSString * const kSHMediatorParamsKeySwiftTargetModuleName = @"kSHMediatorParamsKeySwiftTargetModuleName";

@interface SHMediator ()

@property (nonatomic, strong) NSMutableDictionary *cachedTarget;

@end

@implementation SHMediator

#pragma mark - public methods
+ (instancetype)sharedInstance
{
    static SHMediator *mediator;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mediator = [[SHMediator alloc] init];
...
- (id)performTarget:(NSString *)targetName
  ...
  shouldCacheTarget:(BOOL)shouldCacheTarget {
    ...
    NSString *swiftModuleName = params[kSHMediatorParamsKeySwiftTargetModuleName];
...
SHMediator* _Nonnull CT(void){
    return [SHMediator sharedInstance];
};
